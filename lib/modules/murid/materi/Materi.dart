...
import 'package:skripsi_rinaldo/modules/murid/materi/components/MateriList.dart';
...
class MateriMuridPage extends StatefulWidget {
  @override
  _MateriMuridPageState createState() => _MateriMuridPageState();
}

class _MateriMuridPageState extends State<MateriMuridPage> {
  User _user;
  ...
  _showDialog() async {
    await showDialog<String>(
      builder: (context) => AddClassMuridDialog(user: _user),
      context: context,
    );
  }
}

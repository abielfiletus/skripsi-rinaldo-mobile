...
class DashboardMuridPage extends StatefulWidget {
  @override
  _DashboardMuridPageState createState() => _DashboardMuridPageState();
}

class _DashboardMuridPageState extends State<DashboardMuridPage> {
  User _user;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: BottomNavigationMurid('home'),
      body: _isLoading
          ? Container(

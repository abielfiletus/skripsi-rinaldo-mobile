...
import 'package:skripsi_rinaldo/modules/guru/histories/components/HistoryList.dart';
...
class HistoryGuruPage extends StatefulWidget {
  @override
  _HistoryGuruPageState createState() => _HistoryGuruPageState();
}

class _HistoryGuruPageState extends State<HistoryGuruPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationGuru('history'
      ),

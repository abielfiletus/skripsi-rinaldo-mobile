...
class HistoryListGuru extends StatefulWidget {
  final bool first;
  final bool last;
  ...
  @override
  _HistoryListGuruState createState() => _HistoryListGuruState();
}

class _HistoryListGuruState extends State<HistoryListGuru> {

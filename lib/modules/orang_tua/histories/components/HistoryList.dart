...
class HistoryListOrtu extends StatefulWidget {
  final bool first;
  final bool last;
  ...
  @override
  _HistoryListOrtuState createState() => _HistoryListOrtuState();
}

class _HistoryListOrtuState extends State<HistoryListOrtu> {

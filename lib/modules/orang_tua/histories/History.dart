...
import 'package:skripsi_rinaldo/modules/orang_tua/histories/components/HistoryList.dart';
...
class HistoryOrtuPage extends StatefulWidget {
  @override
  _HistoryOrtuPageState createState() => _HistoryOrtuPageState();
}

class _HistoryOrtuPageState extends State<HistoryOrtuPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationOrtu('history'
      ),
